 ...
 <section id="medicines" style="margin-top: 120px;">
    <div class="row mx-auto container">
        ...
        <div class="card" id="buy-card">
          <img id="detail-btn" data-toggle="modal" data-bs-target="#lovenox" data-target="#lovenox" role="tab" href="#lovenox" src="image/medicines/lovenox@2x.png" class="card-img-top" alt="...">
          <div class="card-body">
            ...
            <div id="lovenox" class="modal fade" tabindex="-1" role="dialog" style="display: none;" >
        ...
        <div class="card" id="buy-card">
          <img src="image/medicines/onpattro@2x.png" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">onpattro</h5>
            <p class="card-text">1000 DA</p>
            <a id="buy" href="#" class="btn ">Details</a>
          </div>
        </div>
        <div class="card" id="buy-card">
          <img src="image/medicines/spinraza@2x.png" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Spinraza</h5>
            <p class="card-text">1000 DA</p>
            <a id="buy" href="#" class="btn ">Details</a>
          </div>
        </div>
