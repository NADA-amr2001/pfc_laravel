...
<body>
 ...
 <section id="food" style="margin-top: 120px;">

            <div class="row mx-auto container">
                <div class="card" id="buy-card">
                  <img src="image/food/sans gluten@2x.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Sans Glutten</h5>
                    <p class="card-text">1000 DA</p>
                    <a id="buy" href="#" class="btn ">Buy Now</a>
                  </div>
                </div>
                <div class="card" id="buy-card">
                  <img src="image/food/mix c@2x.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Mix C</h5>
                    <p class="card-text">1000 DA</p>
                    <a id="buy" href="#" class="btn ">Buy Now</a>
                  </div>
                </div>
                <div class="card" id="buy-card">
                  <img src="image/food/mix c_1@2x.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Mix C</h5>
                    <p class="card-text">1000 DA</p>
                    <a id="buy" href="#" class="btn ">Buy Now</a>
                ...
                <div class="card" id="buy-card">
                  <img src="image/food/mix it@2x.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Mix IT</h5>
                    <p class="card-text">1000 DA</p>
                    <a id="buy" href="#" class="btn ">Buy Now</a>
                  </div>
                </div>
                <div class="card" id="buy-card">
                  <img src="image/food/chef@2x.png" class="card-img-top" alt="...">
                  <div class="card-body">
                ...
                <div class="card" id="buy-card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">VIGOR Gérales</h5>
                    <p class="card-text">1000 DA</p>
                    <a id="buy" href="#" class="btn ">Buy Now</a>
                  </div>
                </div>
                <div class="card" id="buy-card">
                  <img src="image/food/vigor2@2x.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">VIGOR Aux Fruits</h5>
                    <p class="card-text">1000 DA</p>
                    <a id="buy" href="#" class="btn ">Buy Now</a>
                  </div>
                </div>
