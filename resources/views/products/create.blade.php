    ...
    <div class="d-flex justify-content-center h-100">
      <div class="">
        ...
        <div class="d-flex justify-content-center form_container">
          <form style="width: 200px;" method="POST" action="/products" enctype="multipart/form-data">
          @csrf
            <div class="input-group mb-2 mt-2" >
                <input  id="title" type="text" class="form-control input_pass input_user @error('title') is-invalid @enderror" placeholder="Tilte" name="title" value="{{ old('title') }}" required autocomplete="title" autofocus >
                  @error('title')
            ...
            <div class="input-group mb-2">
              <input id="qty" type="number" placeholder="qty" class="form-control" name="qty" required autocomplete="number">
            </div>
            <div class="input-group mb-2">
