...
<body>
    ...
    <div id="app">
      ...
      <div class="modal fade" id="rech">
        ...
        <footer id="footer" class=" text-center mt-5 py-2">
            <div class="row container mx-auto pt-5">
                <div class="footer-one col-lg-4 col-md-6 col-12">
                    <img style="margin-bottom: 20px; font-size: 100px;" id="navlogo" src="/image/footer@2x.png"
                        alt="logo">
                        ...
                        <li>
                            <div class="btn-group">
                                ...
                                <ul style="background-color: #60a3bc;" class="dropdown-menu">
                                    <li><a class="dropdown-item" id="medic-btn"
                                            href="http://127.0.0.1:8000/medicines">
                                            <p>Medicines</p>
                                        </a></li>
                                    <li><a class="dropdown-item" id="food-btn" href="http://127.0.0.1:8000/food">
                                            <p>Food</p>
                                        </a></li>
                                    <li><a class="dropdown-item" id="equip-btn"
                                            href="http://127.0.0.1:8000/equipements">
                                            <p>Equipements</p>
                                        </a></li>
                                </ul>
                            </div>
                                        ...
                                        <div class="mt-4">
                                            <div class="d-flex justify-content-center links">
                                                Don't have an account? <a style="color: #fff;" id="signup-link"
                                                    data-dismiss="modal" id="signup-link" href="#signup"
                                                    data-toggle="modal" data-target="#signup" role="tab"
                                                    data-bs-target="#signup" data-bs-toggle="modal"
                                                    class="ml-2">Sign Up</a>
                                            </div>
                                            <div class="d-flex justify-content-center links">
                                                @if (Route::has('password.request'))
                                                    <a class="ml-2" style="color: #fff;"
                                                        class="btn btn-link" data-dismiss="modal" id="signup-link"
                                                        href="#forgot-password" data-toggle="modal"
                                                        data-target="#forgot-password" role="tab"
        ...
        <!--forgot password-->
        <div class="modal fade " id="forgot-password" aria-hidden="true"
            aria-labelledby="forgot-passwordToggleLabel" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-lg" style="height: 450px; width: 400px; padding: 0;">
                <div class="modal-content user_card">
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="container h-100">
                            <div class="d-flex justify-content-center h-100">
                                <div class="">
                                    ...
                                    <div class="mt-4">
                                        <div class="d-flex justify-content-center links">
                                            <a style="color: #fff;" data-dismiss="modal" id="login-link"
                                                data-toggle="modal" data-target="#login" role="tab" href="#login"
